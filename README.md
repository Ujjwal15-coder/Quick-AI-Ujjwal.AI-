...
Keep your API keys private and never commit .env files to GitHub.
...
The frontend will run on the local development URL provided by Vite, usually:
...
These tools can be used to check API requests, responses, authentication, and errors during development.

🔐 Security
API keys are stored using environment variables.
.env files should not be committed to the repository.
Backend secrets should never be exposed in frontend code.
...
GitHub: https://github.com/Ujjwal15-coder
LinkedIn: https://www.linkedin.com/in/ujjwal-srivastava-844034328
